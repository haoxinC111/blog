...
- 向后兼容性：v1 中避免破坏性变更，但 model prompting behavior 在不同快照之间可能变化，建议固定模型版本并实施 evals。

## 文档链接

- 主文档: https://developers.openai.com/api/reference/overview/
- 忠实双语全文: [openai-dev-14-api-overview-bilingual.md](./openai-dev-14-api-overview-bilingual.md)
